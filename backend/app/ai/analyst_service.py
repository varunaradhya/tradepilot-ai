...
from app.core.config import TRADEPILOT_AI_API_KEY, TRADEPILOT_AI_BASE_URL, TRADEPILOT_AI_MAX_RETRIES, TRADEPILOT_AI_MODEL, TRADEPILOT_AI_PROVIDER, TRADEPILOT_AI_RATE_LIMIT, TRADEPILOT_AI_TIMEOUT_SECONDS
...
def _analyze(context: dict[str, Any]) -> dict[str, Any]:
    ...
    return {"analysis": analysis, "context_summary": _context_summary(context, provider_name)}
