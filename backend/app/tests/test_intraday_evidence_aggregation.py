...
def test_aggregate_paper_performance_groups_symbols_and_exit_reasons():
    trades = [
        SimpleNamespace(symbol="TCS", status="CLOSED", pnl=100.0, reason="TARGET"),
        SimpleNamespace(symbol="TCS", status="CLOSED", pnl=-50.0, reason="STOP"),
        SimpleNamespace(symbol="INFY", status="OPEN", pnl=0.0, reason=None),
    ]
