...
def main():
    ...
    p.add_argument('--db',default='data/research/market_data.sqlite');p.add_argument('--mode',choices=['nifty','equity'],required=True);p.add_argument('--dataset',default='equity_nse_discovery_5m');p.add_argument('--symbol');p.add_argument('--horizon',type=int,default=6);p.add_argument('--min-occurrences',type=int,default=50);p.add_argument('--out',default='data/research/pattern_candidates.json');a=p.parse_args()
