...
export interface AIAnalysis { summary:string; market_view:string; signal:"BUY"|"HOLD"|"SELL"|"NEUTRAL"; confidence:number; reasons:string[]; risks:string[]; opportunities:string[]; watch_items:string[]; data_quality:string; limitations:string[]; generated_at:string; }
