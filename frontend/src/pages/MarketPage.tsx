...
export default function MarketPage() {
  ...
  async function search(nextSymbol = symbol) {
    ...
    try {
      // Load the quote and chart independently so one provider failure does not
      // erase the other part of the market screen.
      const [quoteResult, historyResult] = await Promise.allSettled([
        getQuote(normalized),
        getHistory(normalized, range, "1d"),
      ]);
